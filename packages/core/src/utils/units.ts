 ...
 */
export function toInternalDimension(value: number, unit: 'mm' | 'cm' = 'mm'): number {
 ...
 */
export function fromInternalDimension(internalValue: number, unit: 'mm' | 'cm' = 'mm'): number {
 ...
 * 格式化输出为可读字符串，带单位
 */
export function formatInternal(internalValue: number, unit: 'mm' | 'cm' = 'mm'): string {
 ...
 */
export function formatArea(internalArea: number): string {
