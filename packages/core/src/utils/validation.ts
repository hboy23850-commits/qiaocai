import { Stock, PartGroup, SolverOptions } from '../types/index.js';
 ...
 * 校验求解器整体输入约束
 */
export function validateSolverInput(options: SolverOptions): void {
  ...
  for (const s of stocks) {
    if (
      s.group.material !== firstGroup.material ||
