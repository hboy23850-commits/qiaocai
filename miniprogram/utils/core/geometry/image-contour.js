import { calculatePolygonArea, calculatePolygonBBox, douglasPeucker, } from './polygon.js';
/**
 ...
 * 应用透视变换矩阵将点序列矫正至物理尺寸
 */
export function rectifyPoints(points, H) {
    return points.map((p) => {
 ...
 */
export function extractContourFromBinaryImage(grid, width, height, options = {}) {
 ...
 */
export function findContoursFromImageData(imageData, options = {}) {
    ...
    const th = typeof options.threshold === 'number'
        ? options.threshold
